...
export default function CorpusChristiPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Corpus Christi", url: "/truck-accident-lawyer-corpus-christi" }])} />
        ...
        <div className="mx-auto max-w-3xl px-4 text-center">
          <div className="flex aspect-[16/9] items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-100">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm font-medium text-gray-500">Corpus Christi Area Truck Accident Map</p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Corpus Christi</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Truck Accident FAQ — Corpus Christi
          </h2>
          <div className="mt-10">
