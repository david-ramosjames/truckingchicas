...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Houston, TX | Trucking Chicas",
  description:
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/houston-map.png" alt="Houston area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
