...
export const metadata: Metadata = {
  title: "Oilfield & Tanker Truck Accident Lawyer in Texas | Trucking Chicas",
  description:
...
export default function OilfieldTankerPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: d.title, url: "/oilfield-tanker-truck-accident-lawyer" }])} />
