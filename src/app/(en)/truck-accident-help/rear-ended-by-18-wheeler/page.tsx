...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Truck Accident Help", url: "/truck-accident-help" }, { name: q.fullTitle, url: `/truck-accident-help/rear-ended-by-18-wheeler` }])} />
