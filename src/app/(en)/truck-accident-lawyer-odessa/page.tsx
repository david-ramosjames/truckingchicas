...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Odessa, TX",
  description: "Injured in a truck accident in Odessa or the Permian Basin? Trucking Chicas fights for victims of oilfield-truck and 18-wheeler crashes. Free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-odessa`,
    languages: {
  ...
  openGraph: {
    title: "Truck Accident Lawyer in Odessa, TX",
    description: "Injured in a truck accident in Odessa or the Permian Basin? Trucking Chicas fights for victims of oilfield-truck and 18-wheeler crashes. Free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-odessa`,
  },
};
...
export default function OdessaPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Odessa", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Odessa", url: "/truck-accident-lawyer-odessa" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            ...
            alt="Map of Odessa, Texas and surrounding roads"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Odessa</h3>
      ...
      {/* Nearby Areas */}
      <NearbyAreas currentCity="odessa" locale="en" />
