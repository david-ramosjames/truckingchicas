...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Fort Worth, TX | Trucking Chicas",
  description: "Injured in a truck accident in Fort Worth? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-fort-worth`,
    languages: { en: `${SITE_URL}/truck-accident-lawyer-fort-worth`, es: `${SITE_URL}/es/abogado-accidentes-camion-fort-worth` },
  },
  openGraph: {
    title: "Truck Accident Lawyer in Fort Worth, TX | Trucking Chicas",
    description: "Injured in a truck accident in Fort Worth? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-fort-worth`,
  },
};
...
export default function FortWorthPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Fort Worth", url: "/truck-accident-lawyer-fort-worth" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/cities/fort-worth.jpg" alt="Fort Worth, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/fort-worth-map.png" alt="Fort Worth area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Fort Worth</h3>
