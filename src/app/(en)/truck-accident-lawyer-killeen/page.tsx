...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Killeen, TX",
  description: "Injured in a truck accident in Killeen? Trucking Chicas represents victims of 18-wheeler and commercial-truck crashes near Fort Cavazos. Free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-killeen`,
    languages: {
  ...
  openGraph: {
    title: "Truck Accident Lawyer in Killeen, TX",
    description: "Injured in a truck accident in Killeen? Trucking Chicas represents victims of 18-wheeler and commercial-truck crashes near Fort Cavazos. Free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-killeen`,
  },
};
...
export default function KilleenPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Killeen", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Killeen", url: "/truck-accident-lawyer-killeen" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            ...
            alt="Map of Killeen, Texas and surrounding roads"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Killeen</h3>
      ...
      {/* Nearby Areas */}
      <NearbyAreas currentCity="killeen" locale="en" />
