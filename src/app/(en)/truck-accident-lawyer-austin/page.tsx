...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Austin, TX | Trucking Chicas",
  description: "Injured in a truck accident in Austin? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-austin`,
    languages: { en: `${SITE_URL}/truck-accident-lawyer-austin`, es: `${SITE_URL}/es/abogado-accidentes-camion-austin` },
  },
  openGraph: {
    title: "Truck Accident Lawyer in Austin, TX | Trucking Chicas",
    description: "Injured in a truck accident in Austin? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-austin`,
  },
};
    ...
    <PageShell dict={dict} locale="en">
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/cities/austin.jpg" alt="Austin, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/austin-map.png" alt="Austin area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Austin</h3>
