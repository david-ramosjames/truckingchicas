...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Plano, TX | Trucking Chicas",
  description: "Injured in a truck accident in Plano? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-plano`,
    languages: { en: `${SITE_URL}/truck-accident-lawyer-plano`, es: `${SITE_URL}/es/abogado-accidentes-camion-plano` },
  },
  openGraph: {
    title: "Truck Accident Lawyer in Plano, TX | Trucking Chicas",
    description: "Injured in a truck accident in Plano? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-plano`,
  },
};
...
export default function PlanoPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Plano", url: "/truck-accident-lawyer-plano" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/plano-map.png" alt="Plano area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Plano</h3>
