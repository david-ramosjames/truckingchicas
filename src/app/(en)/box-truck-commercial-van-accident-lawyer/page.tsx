...
export const metadata: Metadata = {
  title: "Box Truck & Commercial Van Accident Lawyer in Texas | Trucking Chicas",
  description:
...
export default function BoxTruckPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: d.title, url: "/box-truck-commercial-van-accident-lawyer" }])} />
      ...
      <section className="py-10">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href={routes.deliveryTruck} className="text-brand-red underline hover:text-brand-red-dark">FedEx & UPS Truck Accidents</Link>
