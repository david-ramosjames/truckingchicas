...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in El Paso, TX | Trucking Chicas",
  description: "Injured in a truck accident in El Paso? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-el-paso`,
    languages: { en: `${SITE_URL}/truck-accident-lawyer-el-paso`, es: `${SITE_URL}/es/abogado-accidentes-camion-el-paso` },
  },
  openGraph: {
    title: "Truck Accident Lawyer in El Paso, TX | Trucking Chicas",
    description: "Injured in a truck accident in El Paso? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-el-paso`,
  },
};
...
export default function ElPasoPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "El Paso", url: "/truck-accident-lawyer-el-paso" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/el-paso-map.png" alt="El Paso area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
