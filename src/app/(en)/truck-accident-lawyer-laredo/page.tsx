...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Laredo, TX",
  description: "Injured in a truck accident in Laredo? Trucking Chicas fights for victims hurt by 18-wheelers on I-35 and near the World Trade Bridge. Free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-laredo`,
    languages: {
  ...
  openGraph: {
    title: "Truck Accident Lawyer in Laredo, TX",
    description: "Injured in a truck accident in Laredo? Trucking Chicas fights for victims hurt by 18-wheelers on I-35 and near the World Trade Bridge. Free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-laredo`,
  },
};
...
export default function LaredoPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Laredo", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Laredo", url: "/truck-accident-lawyer-laredo" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            ...
            alt="Map of Laredo, Texas and surrounding roads"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Laredo</h3>
      ...
      {/* Nearby Areas */}
      <NearbyAreas currentCity="laredo" locale="en" />
