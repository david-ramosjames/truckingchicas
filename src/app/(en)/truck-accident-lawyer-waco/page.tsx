...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Waco, TX",
  description: "Injured in a truck accident in Waco? Trucking Chicas represents victims hurt by 18-wheelers on the I-35 corridor. Free, no-obligation consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-waco`,
    languages: {
  ...
  openGraph: {
    title: "Truck Accident Lawyer in Waco, TX",
    description: "Injured in a truck accident in Waco? Trucking Chicas represents victims hurt by 18-wheelers on the I-35 corridor. Free, no-obligation consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-waco`,
  },
};
...
export default function WacoPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Waco", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Waco", url: "/truck-accident-lawyer-waco" }])} />
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Waco</h3>
      ...
      {/* Nearby Areas */}
      <NearbyAreas currentCity="waco" locale="en" />
