...
export default function CuantoValeMiCasoES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda con Accidentes de Camión", url: "/es/ayuda-accidente-camion" }, { name: q.fullTitle, url: `/es/ayuda-accidente-camion/cuanto-vale-mi-caso` }])} />
