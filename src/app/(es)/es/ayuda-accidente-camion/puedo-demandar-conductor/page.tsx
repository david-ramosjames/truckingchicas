...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      en: `${SITE_URL}/truck-accident-help/can-i-sue-truck-driver`,
      es: `${SITE_URL}/es/ayuda-accidente-camion/puedo-demandar-conductor`,
      "x-default": `${SITE_URL}/truck-accident-help/can-i-sue-truck-driver`,
    },
  },
};

export default function PuedoDemandarConductorES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda con Accidentes de Camión", url: "/es/ayuda-accidente-camion" }, { name: q.fullTitle, url: `/es/ayuda-accidente-camion/puedo-demandar-conductor` }])} />
