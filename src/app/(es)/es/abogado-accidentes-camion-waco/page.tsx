...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Waco, TX",
  description: "¿Lesionado en un accidente de camión en Waco? Trucking Chicas representa a las víctimas de 18 ruedas en el corredor de la I-35. Consulta gratis y sin compromiso.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-waco`,
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-waco`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-waco`,
      "x-default": `${SITE_URL}/truck-accident-lawyer-waco`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en Waco, TX",
    description: "¿Lesionado en un accidente de camión en Waco? Trucking Chicas representa a las víctimas de 18 ruedas en el corredor de la I-35. Consulta gratis y sin compromiso.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-waco`,
  },
};

export default function WacoPageES() {
  const dict = getDictionary("es");
  const d = dict.cityPages.waco;
  const cp = dict.cityPages;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Waco", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Waco", url: "/es/abogado-accidentes-camion-waco" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            src={IMAGES.maps.waco}
            alt="Mapa de Waco, Texas y carreteras cercanas"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Waco</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="waco" locale="es" />
