...
export const metadata: Metadata = {
  ...
  description: "¿Lesionado en un accidente de camión en McAllen o el Valle del Río Grande? Trucking Chicas lucha por las víctimas de choques de 18 ruedas y camiones de carga. Consulta gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-mcallen`,
    languages: {
  ...
  openGraph: {
    title: "Abogado de Accidentes de Camión en McAllen, TX",
    description: "¿Lesionado en un accidente de camión en McAllen o el Valle del Río Grande? Trucking Chicas lucha por las víctimas de choques de 18 ruedas y camiones de carga. Consulta gratis.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-mcallen`,
  },
};

export default function McAllenPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("McAllen", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "McAllen", url: "/es/abogado-accidentes-camion-mcallen" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            src={IMAGES.maps.mcallen}
            alt="Mapa de McAllen, Texas y carreteras cercanas"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en McAllen</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="mcallen" locale="es" />
