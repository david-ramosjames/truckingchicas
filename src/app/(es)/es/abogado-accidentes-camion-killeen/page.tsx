...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Killeen, TX",
  description: "¿Lesionado en un accidente de camión en Killeen? Trucking Chicas representa a las víctimas de choques de 18 ruedas y camiones comerciales cerca de Fort Cavazos. Consulta gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-killeen`,
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-killeen`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-killeen`,
      "x-default": `${SITE_URL}/truck-accident-lawyer-killeen`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en Killeen, TX",
    description: "¿Lesionado en un accidente de camión en Killeen? Trucking Chicas representa a las víctimas de choques de 18 ruedas y camiones comerciales cerca de Fort Cavazos. Consulta gratis.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-killeen`,
  },
};

export default function KilleenPageES() {
  const dict = getDictionary("es");
  const d = dict.cityPages.killeen;
  const cp = dict.cityPages;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Killeen", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Killeen", url: "/es/abogado-accidentes-camion-killeen" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            src={IMAGES.maps.killeen}
            alt="Mapa de Killeen, Texas y carreteras cercanas"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Killeen</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="killeen" locale="es" />
        ...
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <div className="mt-8">
            ...
            >
              ...
              <span className="lg:hidden">Llame Ahora — Consulta Gratis</span><span className="hidden lg:inline">Llame Ahora: {PHONE_DISPLAY}</span>
            </a>
          </div>
