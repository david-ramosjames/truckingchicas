...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en San Antonio, TX | Trucking Chicas",
    ...
    <PageShell dict={dict} locale="es">
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/cities/san-antonio.jpg" alt="San Antonio, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/san-antonio-map.png" alt="Mapa del área de San Antonio" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
