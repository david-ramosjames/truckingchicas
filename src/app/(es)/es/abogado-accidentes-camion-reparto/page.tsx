...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-reparto`,
    languages: {
...
export default function DeliveryTruckPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: d.title, url: "/es/abogado-accidentes-camion-reparto" }])} />
      ...
      <section className="py-10">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href={routes.eighteenWheeler} className="text-brand-red underline hover:text-brand-red-dark">Accidentes de 18 Ruedas</Link>
