...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Laredo, TX",
  description: "¿Lesionado en un accidente de camión en Laredo? Trucking Chicas lucha por las víctimas de 18 ruedas en la I-35 y cerca del Puente de Comercio Mundial. Consulta gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-laredo`,
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-laredo`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-laredo`,
      "x-default": `${SITE_URL}/truck-accident-lawyer-laredo`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en Laredo, TX",
    description: "¿Lesionado en un accidente de camión en Laredo? Trucking Chicas lucha por las víctimas de 18 ruedas en la I-35 y cerca del Puente de Comercio Mundial. Consulta gratis.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-laredo`,
  },
};

export default function LaredoPageES() {
  const dict = getDictionary("es");
  const d = dict.cityPages.laredo;
  const cp = dict.cityPages;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Laredo", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Laredo", url: "/es/abogado-accidentes-camion-laredo" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            src={IMAGES.maps.laredo}
            alt="Mapa de Laredo, Texas y carreteras cercanas"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Laredo</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="laredo" locale="es" />
