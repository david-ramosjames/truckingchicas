...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Beaumont, TX",
  description: "¿Lesionado en un accidente de camión en Beaumont? Trucking Chicas representa a las víctimas de choques de 18 ruedas, cisternas y camiones de refinería en la I-10. Consulta gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-beaumont`,
    languages: {
  ...
  openGraph: {
    title: "Abogado de Accidentes de Camión en Beaumont, TX",
    description: "¿Lesionado en un accidente de camión en Beaumont? Trucking Chicas representa a las víctimas de choques de 18 ruedas, cisternas y camiones de refinería en la I-10. Consulta gratis.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-beaumont`,
  },
};

export default function BeaumontPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Beaumont", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Beaumont", url: "/es/abogado-accidentes-camion-beaumont" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.beaumont} alt="Beaumont, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Beaumont</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="beaumont" locale="es" />
