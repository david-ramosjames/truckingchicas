...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-el-paso`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-el-paso`,
      "x-default": `${SITE_URL}/truck-accident-lawyer-el-paso`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en El Paso, TX",
...
export default function ElPasoPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "El Paso", url: "/es/abogado-accidentes-camion-el-paso" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en El Paso</h3>
      ...
      <section className="bg-gray-50 py-16"><div className="mx-auto max-w-3xl px-4"><h2 className="text-center text-3xl font-bold text-brand-navy">Preguntas Frecuentes: El Paso</h2><div className="mt-10"><FAQAccordion items={d.faq} /></div></div></section>
