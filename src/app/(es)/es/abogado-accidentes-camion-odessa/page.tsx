...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Odessa, TX",
  description: "¿Lesionado en un accidente de camión en Odessa o la Cuenca Pérmica? Trucking Chicas lucha por las víctimas de choques de camiones petroleros y 18 ruedas. Consulta gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-odessa`,
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-odessa`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-odessa`,
      "x-default": `${SITE_URL}/truck-accident-lawyer-odessa`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en Odessa, TX",
    description: "¿Lesionado en un accidente de camión en Odessa o la Cuenca Pérmica? Trucking Chicas lucha por las víctimas de choques de camiones petroleros y 18 ruedas. Consulta gratis.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-odessa`,
  },
};

export default function OdessaPageES() {
  const dict = getDictionary("es");
  const d = dict.cityPages.odessa;
  const cp = dict.cityPages;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Odessa", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Odessa", url: "/es/abogado-accidentes-camion-odessa" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          <Image
            src={IMAGES.maps.odessa}
            alt="Mapa de Odessa, Texas y carreteras cercanas"
            width={1300}
            height={676}
            className="h-auto w-full rounded-xl"
            sizes="(max-width: 768px) calc(100vw - 32px), 736px"
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Odessa</h3>
      ...
      {/* Áreas Cercanas */}
      <NearbyAreas currentCity="odessa" locale="es" />
