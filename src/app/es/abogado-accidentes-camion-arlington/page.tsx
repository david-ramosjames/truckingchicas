...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Arlington, TX | Trucking Chicas",
  description: "¿Lesionado en un accidente de camión en Arlington? Trucking Chicas ayuda a las víctimas a recuperar compensación. Llame ahora para una consulta gratuita.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-arlington`,
    languages: {
  ...
  openGraph: {
    title: "Abogado de Accidentes de Camión en Arlington, TX | Trucking Chicas",
    description: "¿Lesionado en un accidente de camión en Arlington? Trucking Chicas ayuda a las víctimas a recuperar compensación. Llame ahora para una consulta gratuita.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-arlington`,
  },
};
...
export default function ArlingtonPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Arlington", url: "/es/abogado-accidentes-camion-arlington" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/cities/arlington.jpg" alt="Arlington, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/arlington-map.png" alt="Mapa del área de Arlington" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Arlington</h3>
      ...
      <section className="bg-gray-50 py-16"><div className="mx-auto max-w-3xl px-4"><h2 className="text-center text-3xl font-bold text-brand-navy">Preguntas Frecuentes — Arlington</h2><div className="mt-10"><FAQAccordion items={d.faq} /></div></div></section>
