...
export const metadata: Metadata = {
  title: "¿Tengo un Caso Si Me Golpeó un Semi Camión? | Trucking Chicas",
  description: "¿Lo golpeó un semi camión en Texas? Aprenda si tiene un caso, qué evidencia importa y cómo proteger sus derechos.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-accidente-camion/tengo-un-caso`,
  },
};

export default function TengoUnCasoES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda con Accidentes de Camión", url: "/es/ayuda-accidente-camion" }, { name: q.fullTitle, url: `/es/ayuda-accidente-camion/tengo-un-caso` }])} />
