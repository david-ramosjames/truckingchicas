...
export const metadata: Metadata = {
  title: "Abogado de Accidentes de Camión en Plano, TX | Trucking Chicas",
  description: "¿Lesionado en un accidente de camión en Plano? Trucking Chicas ayuda a las víctimas a recuperar compensación. Llame ahora para una consulta gratuita.",
  alternates: {
    canonical: `${SITE_URL}/es/abogado-accidentes-camion-plano`,
    languages: {
      en: `${SITE_URL}/truck-accident-lawyer-plano`,
      es: `${SITE_URL}/es/abogado-accidentes-camion-plano`,
    },
  },
  openGraph: {
    title: "Abogado de Accidentes de Camión en Plano, TX | Trucking Chicas",
    description: "¿Lesionado en un accidente de camión en Plano? Trucking Chicas ayuda a las víctimas a recuperar compensación. Llame ahora para una consulta gratuita.",
    url: `${SITE_URL}/es/abogado-accidentes-camion-plano`,
  },
};
...
export default function PlanoPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Plano", url: "/es/abogado-accidentes-camion-plano" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/cities/plano.jpg" alt="Plano, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Ubicaciones de Alto Riesgo en Plano</h3>
      ...
      <section className="bg-gray-50 py-16"><div className="mx-auto max-w-3xl px-4"><h2 className="text-center text-3xl font-bold text-brand-navy">Preguntas Frecuentes — Plano</h2><div className="mt-10"><FAQAccordion items={d.faq} /></div></div></section>
