...
export const metadata: Metadata = {
  title: "Truck Accident Lawyer in Arlington, TX | Trucking Chicas",
  description: "Injured in a truck accident in Arlington? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
  alternates: {
    canonical: `${SITE_URL}/truck-accident-lawyer-arlington`,
    languages: { en: `${SITE_URL}/truck-accident-lawyer-arlington`, es: `${SITE_URL}/es/abogado-accidentes-camion-arlington` },
  },
  openGraph: {
    title: "Truck Accident Lawyer in Arlington, TX | Trucking Chicas",
    description: "Injured in a truck accident in Arlington? Trucking Chicas helps victims recover compensation. Call now for a free consultation.",
    url: `${SITE_URL}/truck-accident-lawyer-arlington`,
  },
};
...
export default function ArlingtonPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Arlington", url: "/truck-accident-lawyer-arlington" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src="/maps/arlington-map.png" alt="Arlington area truck accident map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">High-Risk Locations in Arlington</h3>
