        ...
        <div className="mt-8 rounded-xl bg-brand-navy p-6 text-center text-white md:p-8">
          ...
          <div className="mt-6 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              className="btn-lift btn-glow-coral flex items-center gap-2 rounded-xl bg-brand-red px-8 py-4 text-lg font-bold text-white transition-colors hover:bg-brand-red-light"
            >
            ...
            <Link
              href={routes.contact}
              className="btn-lift flex items-center gap-2 rounded-xl bg-brand-red-dark px-8 py-4 text-lg font-bold text-white transition-colors hover:bg-[#A52222]"
            >
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
