    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-[slideUp_0.3s_ease-out] rounded-2xl bg-white p-6 shadow-2xl md:p-8">
        ...
        >
          ...
          <span className="lg:hidden">{isEn ? "Call Now — Free Consultation" : "Llamar Ahora — Consulta Gratis"}</span><span className="hidden lg:inline">{isEn ? `Call Now: ${PHONE_DISPLAY}` : `Llame Ahora: ${PHONE_DISPLAY}`}</span>
        </a>
